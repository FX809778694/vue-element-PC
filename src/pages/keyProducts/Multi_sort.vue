    ...
    <div class="sort_wrap">
      ...
      <div v-show="filterStatus" class="condition_wrap">
        ...
        <div class="sort_item_wrap">
          <dl class="sort_cont clearfix">
            <dt class="sort_title">出版社：</dt>
            <dd class="sort_group clearfix">
              <div class="list_wrap publisher_group">
                <ul class="list_cont clearfix">
                  <li
                    @click="handleSelectPublisher(item)"
                    v-for="(item, index) in publisherData"
                    :key="index"
                    :class="{ 'active': item.active }"
                    class="fl"
                  >
                    <div class="key-hover-border">
                      <img class="key-hover-img" v-lazy="item.ImgUrl ? item.ImgUrl : noBook" width="140" height="52" alt="出版社">
                    </div>
                  </li>
                </ul>
              </div>
...
export default {
  ...
  methods: {
    ...
    handleMultiSelect(index, key) {
      const oUl = document.querySelectorAll(".list_cont")[index + 1];
    ...
    handleSelectPublisher(item) {
      this.$emit("selectPublisher", item);
    }
  }
};
</script>
...
.mutiple_sort {
  box-shadow: inset 0px 1px 1px 0 #d9d9d9;
  .sort_wrap {
    width: 1200px;
    margin: 0 auto;
  }
  ...
  .sort_item_wrap {
    ...
    .publisher_group {
      ...
      li.active:after {
        ...
        width: 20px;
        height: 20px;
        background: url("../../assets/icon-hook.png") no-repeat;
...
.key-hover-img:hover.key-hover-img{
