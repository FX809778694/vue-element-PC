          ...
          <div class="clearfix picture-content-layout">
            <div class="picture-content fl" v-for="(item, index) in tableData" :key="item.Id">
              ...
              <div class="picture-content-number">
                <el-input-number size="mini" :min="1" controls-position="right" v-model.trim="item.Count"></el-input-number>
              </div>
  ...
  methods: {
    ...
    handleCheckAllChange(val) {
      ...
      if (val) {
        ...
        this.tablkeData.forEach((item, index) => {
